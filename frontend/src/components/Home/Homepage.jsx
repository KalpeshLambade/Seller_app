...
const Homepage = () => {
  ...
  const [city,setCity] = useState(hotels.newYork);
    ...
    <>
      <main className="bg-[#f4f4fd]">
        ...
        <section className=" border-red-600 flex flex-wrap items-center justify-evenly px-11 py-3">
          ...
          {city && city.map((e,i)=>(<div className="bg-white rounded-xl w-80 mx-5 my-3" key={i}>
            {/* Top div  */}
            ...
            <div className="border-red-600 h-48 flex flex-col justify-evenly">
              ...
              <div className="flex items-center justify-evenly">
                <div className="border-2 border-gray-400 border-dotted flex flex-col justify-evenly items-center px-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
              ...
              <div className="flex justify-between px-2 mt-1">
                <p>
                  <span className="text-[#373ae3] font-bold">${e.price}</span>/month
                </p>
        ...
        <div className="border-red-500 flex justify-center items-center">
          <button className="h-10 border border-[#373ae3] m-1 p-1 px-2 rounded-2xl bg-[#373ae3] text-white flex items-center justify-around">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
